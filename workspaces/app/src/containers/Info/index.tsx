        ...
        <DefaultLayout className={classes.root}>
            <Grid container spacing={2} justify='center'>
                <Grid item xs={12} sm={10} md={8} lg={6}>
                    <Faq classes={{root: classes.paper, heading: classes.heading}} />
                </Grid>
                <Grid item xs={12} sm={10} md={4} lg={4}>
                    <Grid container spacing={2} justify='center'>
                        <Grid item xs={12}>
                            <Paper className={classes.paper}>
                                <Typography className={classes.heading} variant='h2' gutterBottom>Support</Typography>
                        ...
                        <Grid item xs={12}>
                            <Paper className={classes.paper}>
                                <Typography className={classes.heading} variant='h2' gutterBottom>Credits</Typography>
                                <Paper className={classes.content}>
